...
class TK_Session extends CI_Session{
...
// 		$sessid .= $this->CI->input->ip_address();
	...
	function _set_cookie($cookie_data = NULL) {
		...
		if (( ! isset($this->first_cookie_sent) ) OR
			($this->userdata['session_id'] != $this->current_cookies['session_id'])
		)
		{
			$this->first_cookie_sent = true;
			$this->current_cookies = $this->userdata;
			// Set the cookie
			setcookie(
